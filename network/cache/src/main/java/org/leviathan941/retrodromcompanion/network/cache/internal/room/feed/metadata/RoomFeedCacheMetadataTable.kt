...
internal object RoomFeedCacheMetadataTable {
    const val TABLE_NAME: String = "feed_cache_metadata"

    const val COLUMN_CHANNEL_URL: String = "channel_url"
    const val COLUMN_ITEMS_LAST_UPDATED: String = "items_last_updated"
}
