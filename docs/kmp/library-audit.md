...
| `io.coil-kt.coil3:coil-compose` | 3.6.2 | yes | |
...
| `io.ktor:ktor-client-okhttp` | Android engine | Keep on Android, add `io.ktor:ktor-client-darwin` 3.5.2 for iOS, engine chosen through DI | A5 / C2 |
